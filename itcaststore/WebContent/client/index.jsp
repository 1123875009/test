...
<body class="main">
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="${pageContext.request.contextPath }${showpic[0].imgurl}"  width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }${showpic[1].imgurl}"  width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }${showpic[2].imgurl}"  width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }${showpic[3].imgurl}"  width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }${showpic[4].imgurl}"  width="900" height="335" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 图书商场首页轮播图  end -->	
