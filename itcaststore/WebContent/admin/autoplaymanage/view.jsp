...
<HEAD>
	...
	<script type="text/javascript">
		function addPicture() {
			window.location.href = "${pageContext.request.contextPath}/admin/autoplaymanage/add.jsp";
		}
	</script>
</HEAD>
<body>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="12%">图片编号</td>
								<td align="center" width="12%">图片标题</td>
								<td align="center" width="24%">图片</td>
